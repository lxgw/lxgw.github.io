...
本表用于初步整理 GB/T 2312-1980、《通用规范汉字表》（2013）、《现代汉语通用字表》（1988）（以下简称「G0」「通规」「现汉通表」）以外较为常见的汉字，共分 5 组，经筛选处理后将会于「霞鹜新晰黑」「霞鹜文楷 GB」的后续版本中加入。（附第 0 组：GB/T 2312-1980 以外的《通用规范汉字表》《现代汉语通用字表》汉字及化学元素中文名称）

下列汉字除第 4 组外，*应在 v1.245 版本的「霞鹜文楷」字体下全部显示*。如无特殊标注则按 Unicode 码位排序，**每个字只出现一次。** 原则上只收录简体字，对于下表中含有的繁体字、异体字、日本新字体（日本简化字），后续会进一步整理和筛选，对于未予收录的字，用木屐符号「〓」表示筛选之后的空位，并在下方按顺序列出筛选掉的详细汉字。仅供参考。
...
㨃㹴㽲䌷䲡仌冚冧叒槏橿檨毴烎獚獛璏瞏苝苨荵菵蒾蚖蚚蟿貒𣏢𣬠𣬶𦗒𩠌𪠸𫍻𫛚𭴊𮀔𮐚𰤕𰱲𰶊𱂐𱅛𱏿𱴟𱴱𲍿
