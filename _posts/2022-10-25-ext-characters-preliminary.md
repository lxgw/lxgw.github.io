---
layout: post
title: 「霞鹜新晰黑」「霞鹜文楷 GB」外字初步整理一览表（22/10/25）
categories: 汉字整理
...
下列汉字*应在 v1.245 版本的「霞鹜文楷」字体下全部显示*。如无特殊标注则按 Unicode 码位排序，**每个字只出现一次。** 原则上只收录简体字，对于下表中含有的繁体字、异体字、日本新字体（日本简化字），后续会进一步整理和筛选。仅供参考。
...
>
> ② GB/T 2312-1980 中收录了「麹」的繁体字「麴」，「霞鹜新晰黑」「霞鹜文楷 GB」未予收录。后续可能出于兼容性考虑收录该字。
>
...
#### 1.1.1 第二辅助集（简称「二辅」）较常用汉字（90～94、13 区）
...
>
> ③ G8 汉字通信子集中收录的点阵字形为「氞`U+6C1E`」，而根据 GB/T 8565.2 第 A2.1.5 条：该字在四辅的交换码为 `4641`，对应字形为「氝`U+6C1D`」（G 源提交来源为 G5-4E49）；电报码为 `8635`，对应点阵字形为「氞」（G 源提交来源为 GE-3E76），考虑到 G8 汉字通信子集是从二辅、四辅、一异表中选取有电报码的汉字，而三辅（G3）、五辅（G5）为二辅、四辅的繁体版本，故参考四辅调整为「氝」，「氞」移至 **1.2**。

### 1.2 未见于 G8，但已收录于《标准电码本》（1983 年修订本）的字（电报码序）

並~~働傑効勳~~匸夊妳尅崑~~崙巖帋廈~~悮旂暎晳樑~~沖浄減湧準~~濬炞畑燿瓩~~盪箇~~籐唡**~~脧~~**<sup>①</sup>龿~~蒞~~**螀**<sup>②</sup>襾~~觔~~讬躭釆铇**𰾠**<sup>③</sup>~~隻~~颕骔鬱吋呎啗坿媮斏椝氞氥癒葠蠭

> ㊟ 字表来源[千千秀字](https://www.qqxiuzi.cn/bianma/dianbao.html)、[焰华 Honoka55](https://honoka55.github.io/p/dianma-ben/)，略有调整。繁异体字较多，将会进行筛选。
>
...
> ☞ 2.1 字表参考方正近几年发布的简体字体。其中 2.1.1 的汉字见于方正早期的简体字库中，但是是以私用区（PUA）字符的形式存在，近几年发布的字体中已对这些字增加了 Unicode 映射。
...
> ☛ 本类别中的汉字参考 https://github.com/eisoch/irg ，整理过程中已筛除繁体字。后续会对这些汉字进行进一步整理和筛选处理。
