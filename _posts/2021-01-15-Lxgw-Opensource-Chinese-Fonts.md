...
**注意：** SIL OFL 与 IPA Font License 各自要求衍生字体以相同的条款发布（「相同方式共享」/ Share Alike），故这两种授权许可彼此不兼容，将这两种不同授权方式的字体混合成的字体不可公开发布。

---

以上字体均为开源字体，允许自由分享、下载、用于商业用途，也欢迎专业人士或业余字体爱好者在这些字体基础上修改、优化或衍生。
